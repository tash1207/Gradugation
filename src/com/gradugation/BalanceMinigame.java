...
public class BalanceMinigame extends BaseGameActivity {
	...
	private ITexture dollar5Texture, dollar1Texture, dollar10Texture, continueTexture;
	private ITextureRegion dollar5TextureRegion, dollar1TextureRegion, dollar10TextureRegion, continueTextureRegion;
	private Font mFont;
	...
	public void onCreateResources(
		...
		try {
			this.dollar5Texture = new AssetBitmapTexture(
					this.getTextureManager(), this.getAssets(),
					"gfx/money_count/5dollar.png");
			this.dollar1Texture = new AssetBitmapTexture(
					this.getTextureManager(), this.getAssets(),
					"gfx/money_count/1dollar.png");
			this.dollar10Texture = new AssetBitmapTexture(
					this.getTextureManager(), this.getAssets(),
					"gfx/money_count/10dollar.png");
		...
		this.dollar5TextureRegion = TextureRegionFactory
				.extractFromTexture(this.dollar5Texture);
		this.dollar5Texture.load();

		this.dollar1TextureRegion = TextureRegionFactory
				.extractFromTexture(this.dollar1Texture);
		this.dollar1Texture.load();
	...
	private void createSprite(float pX, float pY, final Text text) {
		...
		foodList.add(dollar1TextureRegion);
		foodList.add(dollar5TextureRegion);
		...
		final FixtureDef spriteDef = PhysicsFactory.createFixtureDef(1f, 0.5f,
				0.5f);
		final Body body = BalanceMinigame.createBody(this.mPhysicsWorld, sprite,
